...
def run_mtm_monitor(self) -> Dict[str, Any]:
    ...
    try:
        ...
        vega_limit = state.aum * RISK_CFG.layer1_vix_pt_drawdown_pct * 100
    ...
    try:
        ...
        for leg in pos.legs:
            ...
            for step in range(SLIPPAGE_CFG.max_chase_steps + 1):
                ...
                # PRODUCTION: Submit limit order to broker here
                # fill = broker.place_order(leg.symbol, side, leg.lots, limit_price)
...
# Import after definition to avoid circular import in tests
from config import SLIPPAGE_CFG
